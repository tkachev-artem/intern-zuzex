...
import { handleEmailChange, handleLastnameChange, handleNameChange } from "../hooks/useSignUp"
...
export const UserStep = ({ button_action, button_text, handleAuthPage, handleSignupPage }: UserStepProps) => {
